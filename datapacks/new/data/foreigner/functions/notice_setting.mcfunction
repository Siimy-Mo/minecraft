...
execute as @a[team=new,nbt={Dimension:'minecraft:overworld'},x=276472,y=0,z=-431617,dx=5000,dy=255,dz=4000] run tag @s remove invalid_position
...
execute as @a[team=local,nbt={Dimension:'minecraft:overworld'},x=276472,y=0,z=-431617,dx=5000,dy=255,dz=4000] run tag @s add valid_position
execute as @a[team=local,nbt={Dimension:'minecraft:overworld'},x=-2800,y=0,z=-2500,dx=5600,dy=255,dz=5000] run tag @s add valid_position
